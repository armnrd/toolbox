...
namespace toolbox::hacks
{
    void set_display_scaling(int scaling_percentage, int display_index)
    {
        ...
        auto current_resolution = hacks_dpi_scaling::get_dpi_scaling_info(display_data_cache[display_index].adapter_id,
                                                                          display_data_cache[display_index].source_id);

        auto success =
                hacks_dpi_scaling::set_dpi_scaling(display_data_cache[display_index].adapter_id,
                                                   display_data_cache[display_index].source_id, scaling_percentage);
